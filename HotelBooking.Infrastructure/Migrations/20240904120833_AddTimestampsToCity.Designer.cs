...
namespace HotelBooking.Infrastructure.Migrations
{
    ...
    [Migration("20240904120833_AddTimestampsToCity")]
    partial class AddTimestampsToCity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.Discount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FromDate = new DateTime(2024, 8, 25, 0, 0, 0, 0, DateTimeKind.Local),
                            RoomTypeId = new Guid("5a5de3b8-3ed8-4f0a-bda9-cf73225a64a1"),
                            ToDate = new DateTime(2024, 9, 14, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = new Guid("b3f70a88-53e5-4b35-9d08-59632cfaf872"),
                            DiscountPercentage = 15f,
                            FromDate = new DateTime(2024, 8, 30, 0, 0, 0, 0, DateTimeKind.Local),
                            RoomTypeId = new Guid("d67ddbe4-1f1a-4d85-bcc1-ec3a475ecb68"),
                            ToDate = new DateTime(2024, 9, 9, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = new Guid("c6d14b29-1d59-42ab-b13f-15d5939e4ae4"),
                            DiscountPercentage = 20f,
                            FromDate = new DateTime(2024, 9, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            RoomTypeId = new Guid("4b4c0ea5-0b9a-4a20-8ad9-77441fb912d2"),
                            ToDate = new DateTime(2024, 9, 11, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("841a0a03-f6e6-4581-8c62-5d61d5ab0012"),
                            Format = "Jpg",
                        ...
                        new
                        {
                            Id = new Guid("ea084f61-7129-48a7-82d7-4ce7babba07c"),
                            Format = "Jpg",
                        ...
                        new
                        {
                            Id = new Guid("d9004ebc-b656-4b75-82d7-eca227ca9754"),
                            Format = "Jpg",
                        ...
                        new
                        {
                            Id = new Guid("c0c88162-fc33-4b0e-8060-f146a593cf2b"),
                            CityId = new Guid("c2f87e1e-3cf0-4c3e-b09b-bb2d8e5b74b9"),
                            Format = "Png",
                            OwnerType = "City",
                            Type = "Thumbnail",
                        ...
                        new
                        {
                            Id = new Guid("7660e493-d9ec-4bc8-b6dd-63f916a1fd89"),
                            CityId = new Guid("b1f8b3e4-4e30-4c6b-8c4f-2c9c9de7d517"),
                            Format = "Png",
                            OwnerType = "City",
                            Type = "Thumbnail",
                        ...
                        new
                        {
                            Id = new Guid("3c6917ce-4dbd-43c4-a175-138e9d660213"),
                            CityId = new Guid("4a7d5f20-8b3d-4b9c-b9b6-ecb2bbd25e3c"),
                            Format = "Png",
                            OwnerType = "City",
                            Type = "Gallery",
